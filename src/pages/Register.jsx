...
const Register = () => {
  ...
  const hasSixCharacters = passwordValue.length >= 6;

  const Requirement = ({ isValid, text }) => (
    <p
      className={`flex items-center gap-2 text-xs font-semibold ${
        isValid ? "text-emerald-300" : "text-slate-400"
      }`}
    >
      <FaCheckCircle
        className={isValid ? "text-emerald-300" : "text-slate-500"}
      />
      {text}
    </p>
  );
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="Enter your password"
                      className="relative z-10 w-full pl-11 pr-12 py-3 rounded-2xl bg-white/10 border border-white/10 text-white placeholder:text-slate-400 outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-400/30 transition-all duration-300"
                      name="password"
                      required
                      value={passwordValue}
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 z-20 text-slate-400 hover:text-pink-300 transition"
                    >
                  ...
                  {passwordValue && (
                    <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 rounded-2xl bg-white/10 border border-white/10 p-4">
                      <Requirement
                        isValid={hasUppercase}
                        text="Must include uppercase"
                      />
                      <Requirement
                        isValid={hasLowercase}
                        text="Must include lowercase"
                      />
                      <Requirement
                        isValid={hasSpecial}
                        text="Must include special character"
                      />
                      <Requirement
                        isValid={hasSixCharacters}
