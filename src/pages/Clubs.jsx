  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 min-h-screen overflow-hidden bg-[linear-gradient(135deg,#ecfeff_0%,#ffffff_38%,#f5f3ff_72%,#fff1f2_100%)]">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Search and Filter */}
        <div className="mb-12 rounded-[2rem] bg-white/85 backdrop-blur-xl border border-white shadow-2xl p-5 md:p-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
            <div className="lg:col-span-7">
              ...
              <input
                ...
                className="input input-bordered mt-2 w-full rounded-2xl bg-white border-cyan-100 focus:border-cyan-400 focus:outline-none text-slate-700"
              />
            </div>
            ...
            <div className="lg:col-span-4">
              ...
              <select
                ...
                className="select select-bordered mt-2 w-full rounded-2xl bg-white border-violet-100 focus:border-violet-400 focus:outline-none text-slate-700"
              >
            ...
            <div className="lg:col-span-1 flex lg:justify-end">
              <button
                ...
                className="btn mt-7 lg:mt-8 w-full lg:w-auto rounded-2xl border-none bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 text-white font-black shadow-lg shadow-cyan-500/25"
              >
                Reset
              </button>
            </div>
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
            <p className="text-sm font-semibold text-slate-500">
              ...
              of <span className="font-black">{clubs.length}</span> clubs
            </p>

            {(searchText || selectedCategory !== "all") && (
              <span className="rounded-full bg-gradient-to-r from-cyan-50 to-violet-50 px-5 py-2 text-sm font-bold text-slate-600 border border-cyan-100">
        ...
        {filteredClubs.length === 0 && (
          <div className="max-w-2xl mx-auto mt-10 rounded-[2rem] bg-white/80 backdrop-blur-xl border border-white shadow-2xl p-12 text-center">
            ...
            <p className="text-slate-600">
              Try another club name or choose a different category.
            </p>
          </div>
        )}
      </div>
