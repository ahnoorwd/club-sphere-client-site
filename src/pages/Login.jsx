...
//                         type="password"
//                         name="password"
//                         placeholder="Enter your password must be 6 characters and speccial character&capital&small&number"
...
const Login = () => {
  ...
  const isPasswordValid =
    hasUppercase && hasLowercase && hasSpecial && hasSixCharacters;
  ...
  const handlelogin = (e) => {
    ...
    if (!isPasswordValid) {
      toast.error(
        "Password must include uppercase, lowercase, special character, and at least 6 characters."
      );
      return;
    }
